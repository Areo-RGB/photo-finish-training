...
This project is indexed by GitNexus as **photo-finish-training** (1835 symbols, 4534 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
